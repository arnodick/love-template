...
offgrid.level={}
offgrid.level.city={}
offgrid.level.city.make = function(g,l)
	local m={}
	m.text={}
	m.arguments={}
	m.functions={}
...
offgrid.level.city.control = function(g,l)
end
offgrid.level.city.draw = function(g,l)
...
offgrid.level.word={}
offgrid.level.word.make = function(g,l)
	sfx.play(g,20)
	local m={}
	m.text={}
	m.arguments={}
...
offgrid.level.word.control = function(g,l)
end
offgrid.level.word.draw = function(g,l)
end

offgrid.level.offgrid={}
offgrid.level.offgrid.make = function(g,l)
...
offgrid.level.offgrid.control = function(g,l)	
end
draw = function(g,l)
end
...
offgrid.gameplay={}
offgrid.gameplay.make = function(g)
	g.map={}
...
offgrid.gameplay.keypressed = function(g,key)
	if key=='escape' then
		game.state.make(g,"title")
	end
end
offgrid.gameplay.gamepadpressed = function(g,joystick,button)
	if button=="a" then
		g.switch = not g.switch
	end
end
offgrid.gameplay.draw = function (g)
...
offgrid.title={}
offgrid.title.make = function(g)
	g.introstart=true
end
offgrid.title.keypressed = function(g,key)
...
offgrid.title.gamepadpressed = function(g,joystick,button)
...
offgrid.intro.control = function(g)
	if g.transition then
		transition.control(g,g,g.transition)
	end
end
offgrid.intro.keypressed = function(g,key)
	if game.keyconfirm(key) then
		game.state.make(g,"title")
	end
end
offgrid.intro.gamepadpressed = function(g,joystick,button)
	if button=="start" or button=="a" then
		game.state.make(g,"title")
	end
end
offgrid.intro.draw = function(g)
