...
local function keypressed(g,key)
	if _G[Enums.games.states.options[g.state.st]]["keypressed"] then
		_G[Enums.games.states.options[g.state.st]]["keypressed"](g,key)
	end
end

local function gamepadpressed(g,button)
	if _G[Enums.games.states.options[g.state.st]]["gamepadpressed"] then
		_G[Enums.games.states.options[g.state.st]]["gamepadpressed"](g,button)
	end
end
