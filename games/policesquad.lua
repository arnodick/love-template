...
policesquad.gameplay.make = function(g)
...
policesquad.gameplay.keypressed = function(g,key)
...
policesquad.gameplay.gamepadpressed = function(g,joystick,button)
...
policesquad.title={}
policesquad.title.keypressed = function(g,key)
...
policesquad.title.gamepadpressed = function(g,joystick,button)
...
policesquad.title.draw = function(g)
	LG.print("policesquad title", g.width/2, g.height/2)
end

policesquad.intro={}
policesquad.intro.keypressed = function(g,key)
	if game.keyconfirm(key) then
		game.state.make(g,"title")
	end
end
policesquad.intro.gamepadpressed = function(g,joystick,button)
	if button=="start" or button=="a" then
		game.state.make(g,"title")
	end
end
policesquad.intro.draw = function(g)
