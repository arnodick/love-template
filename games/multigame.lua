...
multigame.intro =
{
	make = function(g)
		...
		module.make(g.hud,EM.menu,EMM.interactive,g.width/2,180,400,30,{"PROTOSNAKE","WITCHEZ & WIZZEZ"},EC.orange,EC.dark_green,"left",{game.make,game.make},{{Enums.games.protosnake,8,8,320,240,1},{Enums.games.bighands,8,8,640,480,1}})
	end,
