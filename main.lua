...
function love.load()
	--Game = game.make(Enums.games.protosnake,Enums.games.screens.normal_renderer,8,8,320,240,1)--TODO this is where load from ini or whatever will happen. or rather, laod from type! g.t=Enums.games.PROTOSNAKE
	--Game = game.make(Enums.games.iso,Enums.games.screens.normal_renderer,32,32,640,640,1)
	--Game = game.make(Enums.games.rpg,Enums.games.screens.normal_renderer,8,8,320,240,1)
	Game = game.make(Enums.games.offgrid,Enums.games.screens.text_renderer,8,8,640,960,1)
