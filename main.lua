...
Enums = enums.load("","actors","physics","games","states","levels","modules","flags")--enumerators
...
function love.load()
	--Game = game.make(Enums.games.protosnake,Enums.physics.topdown,8,8,320,240,1)--TODO this is where load from ini or whatever will happen. or rather, laod from type! g.t=Enums.games.PROTOSNAKE
	Game = game.make(Enums.games.rpg,Enums.physics.roguelike,8,8,320,240,1)
