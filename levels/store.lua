local function make(l)
	...
	i1.menu=menu.make(EM.text,i1.x,i1.y,24,24,"$"..i1.cost,EC.white,EC.dark_gray,EC.white,EC.dark_gray)
	...
	i2.menu=menu.make(EM.text,i2.x,i2.y,24,24,"$"..i2.cost,EC.white,EC.dark_gray,EC.white,EC.dark_gray)
	...
	i3.menu=menu.make(EM.text,i3.x,i3.y,24,24,"$"..i3.cost,EC.white,EC.dark_gray,EC.white,EC.dark_gray)
end
